...
def get_args():
  ...
  parser.add_argument('--heuristic', type=str, default='manhattan_distance', choices=['manhattan_distance', 'xy', 'misplaced_tiles', 'linear_conflict', 'pattern_database'], help="set the heuristic function used by the algorithm. Default to manhattan_distance.")
  ...
  parser.add_argument('--shuffle', type=lambda x: is_valid_shuffle(parser, x), default=30, help="set how many iterations are done to make the goal puzzle.")
