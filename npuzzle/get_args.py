...
def get_args():
  ...
  parser.add_argument('--heuristic', type=str, default='manhattan_distance', choices=['manhattan_distance', 'pattern_database'], help="set the heuristic function used by IDA*. Default to manhattan_distance.")
